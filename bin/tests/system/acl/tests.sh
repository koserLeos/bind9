...
$DIG $DIGOPTS tsigzone. \
	@10.53.0.2 -b 10.53.0.1 axfr -y $HMAC_ALGORITHM:one:1234abcd8765 > dig.out.${t}
...
t=`expr $t + 1`
$DIG $DIGOPTS tsigzone. \
	@10.53.0.2 -b 10.53.0.1 axfr -y $HMAC_ALGORITHM:two:1234abcd8765 > dig.out.${t}
grep "^;" dig.out.${t} > /dev/null 2>&1 && { echo_i "test $t failed" ; status=1; }
...
t=`expr $t + 1`
$DIG $DIGOPTS tsigzone. \
	@10.53.0.2 -b 127.0.0.1 axfr -y $HMAC_ALGORITHM:two:1234abcd8765 > dig.out.${t}
grep "^;" dig.out.${t} > /dev/null 2>&1 || { echo_i "test $t failed" ; status=1; }

t=`expr $t + 1`
$DIG $DIGOPTS tsigzone. \
	@10.53.0.2 -b 127.0.0.1 axfr -y $HMAC_ALGORITHM:one:1234abcd8765 > dig.out.${t}
grep "^;" dig.out.${t} > /dev/null 2>&1 && { echo_i "test $t failed" ; status=1; }
...
t=`expr $t + 1`
$DIG $DIGOPTS tsigzone. \
	@10.53.0.2 -b 10.53.0.2 axfr -y $HMAC_ALGORITHM:two:1234abcd8765 > dig.out.${t}
grep "^;" dig.out.${t} > /dev/null 2>&1 && { echo_i "test $t failed" ; status=1; }

# should succeed
t=`expr $t + 1`
$DIG $DIGOPTS tsigzone. \
	@10.53.0.2 -b 10.53.0.2 axfr -y $HMAC_ALGORITHM:one:1234abcd8765 > dig.out.${t}
grep "^;" dig.out.${t} > /dev/null 2>&1 && { echo_i "test $t failed" ; status=1; }
...
t=`expr $t + 1`
$DIG $DIGOPTS tsigzone. \
	@10.53.0.2 -b 127.0.0.1 axfr -y $HMAC_ALGORITHM:three:1234abcd8765 > dig.out.${t}
grep "^;" dig.out.${t} > /dev/null 2>&1 || { echo_i "test $t failed" ; status=1; }
...
t=`expr $t + 1`
$DIG $DIGOPTS tsigzone. \
	@10.53.0.2 -b 10.53.0.3 axfr -y $HMAC_ALGORITHM:one:1234abcd8765 > dig.out.${t}
grep "^;" dig.out.${t} > /dev/null 2>&1 || { echo_i "test $t failed" ; status=1; }
