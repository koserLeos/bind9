...
tmp=0
$DIG $DIGOPTS tsigzone. @10.53.0.2 axfr -y hmac-sha256:tsigzone.:1234abcd8765 > dig.out.ns2.test$n || tmp=1
grep "^;" dig.out.ns2.test$n | cat_i
...
#
wait_for_xfer_tsig () {
	$DIG $DIGOPTS tsigzone. @10.53.0.3 axfr -y hmac-sha256:tsigzone.:1234abcd8765 > dig.out.ns3.test$n || return 1
	grep "^;" dig.out.ns3.test$n > /dev/null && return 1
	return 0
}
...
$DIG $DIGOPTS example. @10.53.0.8 axfr \
	-y hmac-sha256:key1.:1234abcd8765 > dig.out.msgsize.test$n || status=1
