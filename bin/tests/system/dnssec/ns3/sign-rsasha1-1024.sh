...
# FIPS build to be used to generate it.

zone=rsasha1-1024.example
k1=$(dnssec-keygen -a rsasha1 -b 1024 $zone)
k2=$(dnssec-keygen -a rsasha1 -b 1024 -f KSK $zone)
...
dnssec-signzone -e +2147480047 -o $zone -f $zone.db -O full $zone.tmp
