...
wait_for_log 45 'notify to 10.53.10.53 failed: timed out: retrying over TCP' ns3/named.run || ret=1
test_end
...
nextpartreset ns3/named.run
wait_for_log 30 'notify to 10.53.10.53 failed: retries exceeded' ns3/named.run || ret=1
test_end

# the 10.53.0.6 is blackholing us
test_start "checking notify to retry over TCP within 45 seconds"
nextpartreset ns3/named.run
wait_for_log 45 'notify to 10.53.0.6 failed: timed out: retrying over TCP' ns3/named.run || ret=1
test_end

# the TCP timeout is set to 15 seconds, double that for some leeway
test_start "checking notify retries expire within 30 seconds"
nextpartreset ns3/named.run
wait_for_log 30 'notify to 10.53.0.6 failed: retries exceeded' ns3/named.run || ret=1
test_end
