...
rm -f K${zone}.+*+*.private
keyname=`$KEYGEN -q -a RSASHA256 -b 2048 -n zone $zone`
keyname=`$KEYGEN -q -a RSASHA256 -b 2048 -n zone -P now -A now+3600 -f KSK $zone`
keyname=`$KEYGEN -q -a RSASHA512 -b 2048 -n zone $zone`
keyname=`$KEYGEN -q -a RSASHA512 -b 2048 -n zone -f KSK $zone`
$DSFROMKEY -T 1200 $keyname >> ../ns1/root.db

zone=inactivezsk
rm -f K${zone}.+*+*.key
rm -f K${zone}.+*+*.private
keyname=`$KEYGEN -q -a RSASHA256 -b 2048 -n zone -P now -A now+3600 $zone`
keyname=`$KEYGEN -q -a RSASHA256 -b 2048 -n zone -f KSK $zone`
keyname=`$KEYGEN -q -a RSASHA512 -b 2048 -n zone $zone`
keyname=`$KEYGEN -q -a RSASHA512 -b 2048 -n zone -f KSK $zone`
$DSFROMKEY -T 1200 $keyname >> ../ns1/root.db
