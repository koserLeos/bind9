...
#
# Copyright (C) Manuel Klimek <klimek@google.com>
...
def get_tidy_invocation(f, clang_tidy_binary, checks, tmpdir, build_path,
                        ...
                        config, line_filter, use_color, plugins, export_file_name):
  ...
  if tmpdir is not None:
    ...
    if export_file_name is None:
      ...
      # overwrite it.
      (handle, tmpname) = tempfile.mkstemp(suffix='.yaml', dir=tmpdir)
      os.close(handle)
    else:
      start.append(export_file_name)
