...
This version includes changes to the 9.11 branch through and including
those released in 9.11.4-P2. It also includes the following new features:
...
#### BIND (Supported Preview Edition) 9.11.5-S1 (2018)

This version includes changes to the 9.11 branch through and including
those released in 9.11.5. It also includes the following new feature:
